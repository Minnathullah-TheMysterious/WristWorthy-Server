...
export const invoiceHtmlTemplate = (order) => {
  return `
  <!DOCTYPE html>
  <html>
     <head>
        ...
        <style type="text/css">
           ...
           */
           ...
           }import { DISCOUNTED_PRICE } from './../../frontend/src/app/constants';
           a {
           color: #1a82e2;
           }
           img {
                          ...
                          <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                             <tr>
                                <td align="center" valign="top" style="padding: 36px 24px;">
                                   <a href="https://ibb.co/nkxPzKf" target="_blank" style="display: inline-block;">
                                   <img src="https://i.ibb.co/j4nJgjG/logo512.jpg" alt="Logo" border="0" width="48" style="display: block; width: 48px; max-width: 48px; min-width: 48px;">
                                   </a>
                                </td>
                             </tr>
                          </table>
                                ...
                                <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                                   <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                      ...
                                      <tr>
                                         ...
                                         <td align="left" width="25%" style="padding: 6px 12px;font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">$${DISCOUNTED_PRICE(
                                           product?.product_id
                                ...
                                <td align="center" valign="top" style="font-size: 0; border-bottom: 3px solid #d4dadf">
                                   ...
                                   <table align="center" border="0" cellpadding="0" cellspacing="0" width="600">
                                      <tr>
                                         ...
                                         <td align="left" valign="top" width="300">
                                            <![endif]-->
                                            <div style="display: inline-block; width: 100%; max-width: 80%; min-width: 240px; vertical-align: top;">
  ...
  }<br>${order?.shippingAddress?.mandal}<br>${
    order?.shippingAddress?.dist
  }<br>${order?.shippingAddress?.city}<br>${order?.shippingAddress?.state}<br>${
                    ...
                    <tr>
                       <td align="center" valign="top" width="600">
                          ...
                          <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                             ...
                             <tr>
                                <td align="center" bgcolor="#D2C7BA" style="padding: 12px 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 20px; color: #666;">
                                   <p style="margin: 0;">To stop receiving these emails, you can <a href="https://wrist-worthy.vercel.app" target="_blank">unsubscribe</a> at any time.</p>
                                </td>
                             </tr>
                             <!-- end unsubscribe -->
                          </table>
